...
def lookup_emr_record_class(t): # This returns the class name of the record object which corresponds to record type t.
	if hasattr(autogenerated, EMR_NAMES[t]):
		return getattr(autogenerated, EMR_NAMES[t]) # autogenerated
	else:
		# The record type wasn't found in the autogenerated file, therefore we need to use the dummy record stuff.
		return newdummy.fake_record_other
